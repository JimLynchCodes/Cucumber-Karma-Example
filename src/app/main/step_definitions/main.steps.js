...
//     // });
//
//     scenario.Given(/^something$/, function (callback) {
//
//       goto('/');
//
...
//       callback();
//     });
//     scenario.Given(/^$/, function (callback) {
//       inputText('Wash hands');
//       callback();
//     });
//
//     scenario.When(/^I use the calculator$/, function (callback) {
//       add();
//       tasksAfter = getAllTasks();
//       callback();
//     });
//
//     scenario.Then(/^It works.$/, function (callback) {
...
//     });
//
//     scenario.Then(/^I works.$/, function (callback) {
//       tasksAfter = getAllTasks();
